  ...
  return (
    <div className='px-4'>
        ...
        <div className='flex flex-col justify-center items-center '>
            <h1 className='text-[25px] font-bold text-center'>Политика в отношении обработки <br /> персональных данных</h1>
            <div className=' shad_ui py-6 px-4 sm:px-8  mt-[50px]  rounded-[20px]'>
